$(document).ready(function() {
    ...
    function goInstructions(){
        $("body").css({'background-image':'url(assets/images/instructions.png)'});               
        createPageLayout();
    ...
    function chooseJedi(){
        ...
        var jedis = {
            "LukeSkyWalker" : { id:"LukeSkyWalker", name: "Luke Skywalker", hp: "100", ap: "30", iap: "5"},
            "Yoda" : { id:"Yoda", name: "Yoda", hp: "100", ap: "25", iap: "10"},
            "ObiWanKenobi" : { id:"ObiWanKenobi", name: "Obi-Wan Kenobi", hp: "100", ap: "15", iap: "15"},
            "QuiGonJinn" : { id:"QuiGonJinn", name: "Qui-Gon Jinn", hp: "100", ap: "10", iap: "20"}
        }
